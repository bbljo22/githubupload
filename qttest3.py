from PyQt5.QtWidgets import (QApplication, QMainWindow,
                             QPushButton, QPlainTextEdit, QVBoxLayout, QWidget,QLineEdit)
import sys
...
class MainWindow(QMainWindow):# QMainWindow  를 상속
    def __init__(self):
        ...
        self.buttonMul.clicked.connect(self.mul)#self.buttonMul 버튼을 함수 mul 과 연결 (jquery의 on 과동일 )
    ...
    def mul(self, checked):#버튼을 누를때 마다 여기 들어와요
        print('mul 버튼이 눌렸어요',self.lineEditMul.text())#lineEditMul 의 내용을 읽어오는것은 jquery의 text() 메서드와 동일
